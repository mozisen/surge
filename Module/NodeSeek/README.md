...
```
试试手气：
https://raw.githubusercontent.com/mozisen/surge/main/Module/NodeSeek/nodeseek-random.sgmodule

固定5鸡腿：
https://raw.githubusercontent.com/mozisen/surge/main/Module/NodeSeek/nodeseek-fixed.sgmodule
```
...
两种模块只能安装一个，避免同一天重复发起签到请求。默认每天 00:05 执行。
